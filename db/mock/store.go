...
// Source: github.com/0abdullahbhutto0/bank_backend/db/sqlc (interfaces: Store)
//
...
func (m *MockStore) ListEntriesByAccount(ctx context.Context, arg db.ListEntriesByAccountParams) ([]db.Entries, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) TransferTx(ctx context.Context, arg db.TransferTxParams) (db.TransferTxResults, error) {
	m.ctrl.T.Helper()
